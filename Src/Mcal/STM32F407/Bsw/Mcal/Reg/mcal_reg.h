...
//
...
#ifndef _MCAL_REG_2014_12_10_H_
  #define _MCAL_REG_2014_12_10_H_
  ...
  namespace mcal
  {
    namespace reg
    {
      ...
      constexpr std::uint32_t spi1_base       = UINT32_C(0x40013000);
      constexpr std::uint32_t spi2_base       = UINT32_C(0x40003800);
      constexpr std::uint32_t spi3_base       = UINT32_C(0x40003C00);
      ...
      constexpr std::uint32_t tim5_base       = periph_base     + UINT32_C(0x0C00);
      ...
      constexpr std::uint32_t spi1_i2scfgr    = spi1_base       + UINT32_C(0x001C);  // 15-bit register.
      ...
      constexpr std::uint32_t spi2_i2scfgr    = spi2_base       + UINT32_C(0x001C);  // 15-bit register.
      ...
      constexpr std::uint32_t spi3_i2scfgr    = spi3_base       + UINT32_C(0x001C);  // 15-bit register.
      ...
      constexpr std::uint32_t tim5_cr1        = tim5_base       + UINT32_C(0x0000);  // 32-bit register.
      constexpr std::uint32_t tim5_cr2        = tim5_base       + UINT32_C(0x0004);  // 32-bit register.
      constexpr std::uint32_t tim5_smcr       = tim5_base       + UINT32_C(0x0008);  // 32-bit register.
      constexpr std::uint32_t tim5_dier       = tim5_base       + UINT32_C(0x000C);  // 32-bit register.
      constexpr std::uint32_t tim5_sr         = tim5_base       + UINT32_C(0x0010);  // 32-bit register.
      constexpr std::uint32_t tim5_egr        = tim5_base       + UINT32_C(0x0014);  // 32-bit register.
      constexpr std::uint32_t tim5_ccmr1      = tim5_base       + UINT32_C(0x0018);  // 32-bit register.
      constexpr std::uint32_t tim5_ccmr2      = tim5_base       + UINT32_C(0x001C);  // 32-bit register.
      constexpr std::uint32_t tim5_ccer       = tim5_base       + UINT32_C(0x0020);  // 32-bit register.
      constexpr std::uint32_t tim5_cnt        = tim5_base       + UINT32_C(0x0024);  // 32-bit register.
      constexpr std::uint32_t tim5_psc        = tim5_base       + UINT32_C(0x0028);  // 32-bit register.
      constexpr std::uint32_t tim5_arr        = tim5_base       + UINT32_C(0x002C);  // 32-bit register.
      constexpr std::uint32_t tim5_rcr        = tim5_base       + UINT32_C(0x0030);  // 32-bit register.

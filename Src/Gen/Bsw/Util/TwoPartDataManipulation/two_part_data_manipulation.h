...
#ifndef _TWO_PART_DATA_MANIPULATION_2014_10_13_H_
  #define _TWO_PART_DATA_MANIPULATION_2014_10_13_H_

  #include <limits>
  #include <Bsw/Util/UtypeHelper/UtypeHelper.h>

  namespace util
  {
    template<typename short_type,
             typename long_type = typename util::utype_helper<static_cast<unsigned>(std::numeric_limits<short_type>::digits * 2)>::exact>
...
#endif // _TWO_PART_DATA_MANIPULATION_2014_10_13_H_

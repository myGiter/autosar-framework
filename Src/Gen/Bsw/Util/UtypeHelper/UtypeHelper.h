...
#ifndef _UTYPE_HELPER_2014_10_13_H_
  #define _UTYPE_HELPER_2014_10_13_H_

  #include <cstdint>

  namespace util
  {
    template<const unsigned> struct utype_helper { typedef std::uint64_t exact; };
...
#endif // _UTYPE_HELPER_2014_10_13_H_
